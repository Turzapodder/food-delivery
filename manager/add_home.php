...
<div id="wrapper">
        ...
        <div class="main">
            <div>
                <h1 class="text-center"><span class="glyphicon glyphicon-cog"></span>ADD Homemakers</h1>
            ...
            <br><br>
            <div>
                <h3>ADD Homemaker Info</h3>
            </div>
            <div class="container">
              <form action="#" method="post" class="login-email">
                      <p class="login-text" style="font-size: 2rem; font-weight: 800;">Homemaker Details</p>
                <div class="input-group">
                  <input type="text" placeholder="Enter Homemaker Name" name="name" >
                </div>
                <div class="input-group">
      ...
      $query = "INSERT INTO restaurant (name, location, imagepath) Values ('$name', '$location', '$file')";
